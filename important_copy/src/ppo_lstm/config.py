...
class Args:
    ...
    wandb_group: str = 'MiniGrid-MemoryS13_second_phase_try1'
    ...
    num_eval_envs: int = 32  # number of evaluation environments
    eval_steps: int = 32
